const Search = () => {
    return (
        <div className="relative text-gray-300 w-80 p-5 pb-0 mr-16">
            ...
            <input type="search" name="search" placeholder="Search" className="bg-gray-800 h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none bg-purple-white shadow rounded border-0" />
        </div>
    )
}
